...
|:---|:---|:---|
| [`docs/MASTER_RESEARCH_COMPENDIUM.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/MASTER_RESEARCH_COMPENDIUM.md) | **This Document**. The unified master compendium, repository index, paper section citation matrix, and presentation companion. | All papers cited below |
| [`Continual_Safety_Alignment.md`](file:///Users/aryamandev/Developer/blissful-bose/Continual_Safety_Alignment.md) | Full in-repo transcription and analysis of the foundational paper by Bach et al. (ACL 2026). Details problem setup, 3-stage algorithm, and mechanistic findings. | Bach et al. (arXiv:2604.17215) |
| [`RESEARCH_METHODOLOGY_AND_VLM_SPEC.md`](file:///Users/aryamandev/Developer/blissful-bose/RESEARCH_METHODOLOGY_AND_VLM_SPEC.md) | **Authoritative Empirical Source**. Complete numerical tables from Bach et al. (Tables 2, 4, 5, 6, 7, 8 with $\pm \sigma$), full VLM metric definitions, and 4-task sequence specification. | Bach et al. (arXiv:2604.17215), Ji et al. (arXiv:2406.06144), Peng et al. (arXiv:2405.17374) |
| [`STUDY_AND_PRESENTATION_PLAYBOOK.md`](file:///Users/aryamandev/Developer/blissful-bose/STUDY_AND_PRESENTATION_PLAYBOOK.md) | 3-phase study guide, formula breakdown for ASR/BWT/Retention, and tactical prep for advisor meetings. | Bach et al., MM-SafetyBench, FigStep |
| [`ACADEMIC_ALIGNMENT_AND_TRACEABILITY_REPORT.md`](file:///Users/aryamandev/Developer/blissful-bose/ACADEMIC_ALIGNMENT_AND_TRACEABILITY_REPORT.md) | Audit against the email directive from Prof. Thao Minh Le (Sept 1, 2026). Verifies 100% compliance with model size, benchmarks, and phased compute gates. | Advisor Directive (Sept 1, 2026) |
| [`docs/gradient_strategy_dossier.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/gradient_strategy_dossier.md) | Rigorous mathematical and algorithmic dossier of the gradient selection strategy. Analyzes loss pre-filtering, gradient norm computation, quantile cutoffs, and safety basin retention geometry. | Bach et al. §3–§4, Peng et al. §3 |
| [`docs/reproducibility_blueprint.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/reproducibility_blueprint.md) | Python pseudocode for per-sample gradient interception, micro-batch autograd hooks, memory footprint formulas, and open research questions for multimodal settings. | Bach et al. §4.1, Appendix E |
| [`docs/sota_landscape_survey.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/sota_landscape_survey.md) | Comprehensive 20+ paper survey covering 6 methodological families (Data-Centric, Optimizer-Centric, Parameter Isolation, Safety Replay, Representation/Loss, Post-Hoc/Inference). | 20+ papers (see Section 3 below) |
| [`docs/master_research_formulation.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/master_research_formulation.md) | Step-by-step translation guide: maps each step of Bach et al. (§2.3, §3.1, §3.2, §4.1, §5.1, App. F) to its exact VLM equivalent. Includes 10-slide narrative script. | Bach et al. (ACL 2026), FigStep, MM-SafetyBench |
| [`docs/methodology_comparison.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/methodology_comparison.md) | Direct head-to-head comparison of all 6 defense families with honest tradeoffs, compute overheads, and phased inclusion roadmap. | Bach et al., SaLoRA, LARF, EWC, VLGuard |
| [`docs/presentation_blueprint.md`](file:///Users/aryamandev/Developer/blissful-bose/docs/presentation_blueprint.md) | Production-ready 11-slide presentation guide: exact slide titles, visual blueprints, bullet points, speaker notes, and anticipated advisor Q&A. | All project research |
| [`README.md`](file:///Users/aryamandev/Developer/blissful-bose/README.md) | Repository overview, architecture diagrams, and quickstart commands. | Project internal |
| [`.agents/skills/vlm-gradient-safety/SKILL.md`](file:///Users/aryamandev/Developer/blissful-bose/.agents/skills/vlm-gradient-safety/SKILL.md) | Agent anti-hallucination policy skill. Mandates zero invented metrics, strict citation traceability, and distinction between gradient filtering and projection. | Internal Research Rigor Policy |
...
- [x] Review verified baseline numbers in [`RESEARCH_METHODOLOGY_AND_VLM_SPEC.md`](file:///Users/aryamandev/Developer/blissful-bose/RESEARCH_METHODOLOGY_AND_VLM_SPEC.md) (Table 5 & 6).
